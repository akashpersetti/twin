    ...
    return {
      ...
      content: (
        <SectionReveal key={`${exp.role}-${exp.period}`} delay={i * 0.1}>
                <div className="relative border overflow-hidden" style={{ borderColor: 'var(--border)', background: 'var(--surface-1)' }}>
                  ...
                  <div className="relative z-10 p-8 sm:p-10">
                    ...
                    {/* Project label */}
                     <p className="mb-2 text-[10px] font-semibold uppercase tracking-[0.16em]" style={{ color: 'var(--text-quaternary)' }}>
                      Project
                    </p>
                     <p className="mb-6 text-[15px]" style={{ color: 'var(--text-primary)' }}>{exp.project}</p>

                    {/* Bullets */}
                     <p className="mb-4 text-[10px] font-semibold uppercase tracking-[0.16em]" style={{ color: 'var(--text-quaternary)' }}>
                      What I built
                    </p>
